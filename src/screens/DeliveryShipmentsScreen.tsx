...
import type { DeliveryShipment } from "../types/delivery";

type IntegrationItem = Awaited<ReturnType<typeof getDeliveryIntegrations>>[number];

export default function DeliveryShipmentsScreen() {
      ...
      <ScrollView contentContainerStyle={{ padding: 16, gap: 16, paddingBottom: 32 }}>
        <Card>
          <SectionTitle
            ...
            subtitle="Tableau unifie des expeditions, suivis et actions transporteurs."
          />
